...
#   busi_doc/   → books, documents  (PDF, DOCX, TXT, MD)
...
DOC_DIR   = Path(BASE_DIR) / "busi_doc"
...
class KnowledgeBase:
    """
    Unified FAISS index over busi_doc/ and code/.
...
async def upload_doc(file: UploadFile = File(...)):
    """Upload PDF, DOCX, TXT, or MD into busi_doc/ and index immediately."""
