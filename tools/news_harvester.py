...
TELEGRAM_TOKEN   = os.getenv("TELEGRAM_NEWS_BOT_TOKEN", os.getenv("TELEGRAM_BOT_TOKEN", ""))
TELEGRAM_CHAT_ID = os.getenv("TELEGRAM_NEWS_CHAT_ID", os.getenv("TELEGRAM_CHAT_ID", ""))
